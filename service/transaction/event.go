...
func init() {
	// statistic update
	nats.BindTaskToEventAndMakePayload(nats.EventTransactionCreate, nats.TaskStatisticUpdate,
	...
	nats.SubscribeEvent(nats.EventTransactionUpdate, "update_statistic_after_transaction_update",
	...
	nats.BindTaskToEventAndMakePayload(nats.EventTransactionDelete, nats.TaskStatisticUpdate,
		func(eventData transactionModel.Transaction) (transactionModel.StatisticData, error) {
